...
public class GetBlobStoreURLServlet extends HttpServlet {
	...
	private static Logger log = Logger.getLogger(GetBlobStoreURLServlet.class.getName());
	...
	protected void doGet(HttpServletRequest req, HttpServletResponse resp)
		...
		try{
			// creates new blobstore url with  callback servlet - to be called when asynx upload of img is complete
